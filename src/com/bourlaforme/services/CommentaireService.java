...
*/
    ...
    try {
        ...
        preparedStatement.setInt(1, commentaire.getArticle().getId());
        preparedStatement.setString(2, commentaire.getAuteur());
        String cleanedContent = replaceBadWord(commentaire.getContenu(), badWord);
...
public static String replaceBadWord(String originalString, String badWord) {
    String cleanedString = originalString.replaceAll("(?i)\\b" + badWord + "\\b", "***");
