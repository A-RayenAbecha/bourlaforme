 ...
 * @author HP
 */
public class MainReponseController implements Initializable {

    @FXML
    private Button btReponse;
    @FXML
    private Button btReclamation;
    ...
    @FXML
    private void btreponse(ActionEvent event) {
        try {
    ...
    @FXML
    private void btReclamation(ActionEvent event) {
               try {
